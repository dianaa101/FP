...
class Book(Entity):
    def __init__(self, id_, title, author, description, rented_by_customer_id, number_of_rents):
    ...
    def set_multiple(self, id_=None, title=None, author=None, description=None,
                     rented_by_customer_id=None, number_of_rents=None):
